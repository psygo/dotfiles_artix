...
COMPLETE_TIME="${COMPLETE_DIVIDER}${TIME_COLOR} ${TIME}"
COMPLETE_PATH="${COMPLETE_DIVIDER}${PATH_COLOR} ${CURRENT_PATH}"
COMPLETE_BRANCH="${COMPLETE_DIVIDER}${BRANCH_COLOR} \$(${BRANCH})"
COMPLETE_ROOT_OR_NOT="${COMPLETE_DIVIDER}${ROOT_OR_NOT_COLOR} ${ROOT_OR_NOT} ${COMPLETE_DIVIDER}"
